const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://*.leadconnectorhq.com https://va.vercel-scripts.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: https:",
      "connect-src 'self' https://*.supabase.co https://www.google-analytics.com https://www.googletagmanager.com https://*.leadconnectorhq.com https://*.vercel-insights.com https://maps.googleapis.com",
      "frame-src 'self' https://www.googletagmanager.com https://*.leadconnectorhq.com",
