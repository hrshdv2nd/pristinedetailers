      ...
      <div style={{ padding: 32 }}>
        {isActive && plan ? (
          ...
          <div style={{ background: '#fff', borderRadius: 16, padding: 28, border: '1px solid #F0EDE8', marginBottom: 32, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 14, color: '#6B6B6B', margin: '0 0 20px' }}>Choose a plan to start booking premium care.</p>
            <a href="/services" style={{ display: 'inline-block', padding: '10px 24px', background: '#C89B37', color: '#fff', borderRadius: 8, fontWeight: 600, textDecoration: 'none', fontSize: 14 }}>
              View Plans
            </a>
          </div>
        )}
