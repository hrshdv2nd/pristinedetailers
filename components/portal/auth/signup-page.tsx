    ...
    <div style={{ minHeight: '100vh', background: '#FAFAF8', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 440 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 700, color: '#0A0A0A', margin: '0 0 8px' }}>Create your account</h1>
          <p style={{ fontSize: 15, color: '#6B6B6B', margin: 0 }}>Join Pristine Detailers today</p>
        </div>
        ...
        <div style={{ background: '#fff', borderRadius: 16, padding: 32, boxShadow: '0 2px 16px rgba(0,0,0,0.06)', border: '1px solid #F0EDE8' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div>
                ...
                <input name="full_name" type="text" required placeholder="Alex Smith" style={inputStyle} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: 13, fontWeight: 500, color: '#374151', marginBottom: 6 }}>Phone</label>
                <input name="phone" type="tel" placeholder="04xx xxx xxx" style={inputStyle} />
              </div>
            </div>
            <div>
          ...
          <p style={{ fontSize: 12, color: '#9CA3AF', textAlign: 'center', marginTop: 16, lineHeight: 1.5 }}>
            ...
            <Link href="/membership/terms" style={{ color: '#C89B37', textDecoration: 'underline' }}>Terms & Conditions</Link>
          </p>
        </div>

        <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: '#6B6B6B' }}>
          Already have an account?{' '}
          <Link href="/login" style={{ color: '#C89B37', fontWeight: 600, textDecoration: 'none' }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
