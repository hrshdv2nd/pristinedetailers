...
const SECTIONS = [
  {
    heading: 'Who We Are',
    body: [
      'Pristine Detailers ("we", "us", "our") is a ceramic coating, graphene coating, and paint protection film business operating in Melbourne, Victoria, Australia, also offering mobile window tinting.',
