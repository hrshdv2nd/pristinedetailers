      ...
      <section className="pd-sect-hero">
        <div style={{ maxWidth: '1320px', margin: '0 auto', padding: '0 32px' }}>
          ...
          <p style={{ fontSize: 18, color: '#3A3A38', marginTop: 28, maxWidth: 580, lineHeight: 1.6 }}>
            Pristine Detailers is Melbourne&#8217;s highest-rated ceramic, graphene, and paint protection film crew. We&#8217;re always looking for people who care as much as we do - about cars, craft, and the people who own them.
          </p>
        </div>
      </section>
