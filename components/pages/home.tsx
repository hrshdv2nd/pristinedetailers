  ...
  return (
    <section className="pd-sect">
      <div style={{ maxWidth: '1320px', margin: '0 auto', padding: '0 32px' }}>
        ...
        <div className="pd-four-col" style={{ gap: 20, gridTemplateColumns: 'repeat(4, 1fr)' }}>
          {services.map(s => (
            <a
              key={s.tag}
          ...
          >
            ...
            <div style={{ position: 'relative', height: 520 }}>
              <BlobImage variant="b" size={420} rotate={4} color="#0A0A0A" style={{ position: 'absolute', top: 0, right: 0 }}>
                <Image src="https://qwa1skb1dtiy5dzb.public.blob.vercel-storage.com/IMG-20250325-WA0016.jpg" alt="Paint protection film installation on a red Tesla" fill style={{ objectFit: 'cover' }} />
              </BlobImage>
              <div
                style={{
                  position: 'absolute',
